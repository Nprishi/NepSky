        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <div className="text-center">
              ...
              <ul className="text-sm text-gray-600 space-y-2 text-left">
                <li>• {language === 'en' ? 'Search & book flights' : 'उडान खोज्नुहोस् र बुक गर्नुहोस्'}</li>
                <li>• {language === 'en' ? 'View booking history' : 'बुकिङ इतिहास हेर्नुहोस्'}</li>
                <li>• {language === 'en' ? 'Manage profile' : 'प्रोफाइल व्यवस्थापन गर्नुहोस्'}</li>
              </ul>
          ...
          >
            <div className="text-center">
              ...
              <ul className="text-sm text-gray-600 space-y-2 text-left">
                <li>• {language === 'en' ? 'Manage flights & users' : 'उडान र प्रयोगकर्ता व्यवस्थापन'}</li>
                <li>• {language === 'en' ? 'View reports' : 'रिपोर्ट हेर्नुहोस्'}</li>
                <li>• {language === 'en' ? 'System control' : 'प्रणाली नियन्त्रण'}</li>
              </ul>
